...
<form class="pure-form" action="deletestudent.php" method="post">
    <fieldset style="border-radius: 20px;">
        <legend>Delete Student From Kilimani School</legend>
	   <div  class="col-75" style=" padding-right: 120px;">
      <select id="selects" name="student_number" onchange="cos('cs','email')" required="student_number">
        <option value="info" style="font-size: 14px;">--- Select Students Number ---</option>
        <option style="font-size: 14px;"><?php  
           ...
           while ($row = mysqli_fetch_assoc($result)) 
            {
            	echo "<option>"  . $row["student_number"] ."<br>". "</option>";
           }
       ?></option>
