...
<head>
	<meta charset="utf-8">
	<title>Kilimani | Add Module</title>
...
<form class="pure-form" action="addmodule.php" method="post">
    <fieldset style="border-radius: 20px;">
        <legend>Add Module To KILIMANI SCHOOL</legend>
        <input type="number" id="text" name="module_number" placeholder="Module Number" required="id"><br><br>
        <input type="text" id="text" name="name" placeholder="First_name" required="name"><br><br>
