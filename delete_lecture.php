...
<form class="pure-form" action="deletelecture.php" method="post">
    <fieldset style="border-radius: 20px;">
        <legend>Delete Lecture From Kilimani School</legend>
	   <div  class="col-75" style=" padding-right: 120px;">
      <select id="selects" name="module_number" onchange="cos('cs','email')" required="module_number">
        <option value="info" style="font-size: 14px;">--- Select Lecture Number ---</option>
        <option style="font-size: 14px;"><?php  
           ...
           while ($row = mysqli_fetch_assoc($result)) 
            {
            	echo "<option>"  . $row["lecture_number"] ."<br>". "</option>";
           }
       ?></option>
