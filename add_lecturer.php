...
<head>
	<meta charset="utf-8">
	<title>Kilimani | Add Lecturer</title>
...
<form class="pure-form" action="addlecturer.php" method="post">
    <fieldset style="border-radius: 20px;">
        <legend>Add Lecturer To KILIMANI SCHOOL</legend>
        <input type="number" id="text" name="lecturer_number" placeholder="Lecturer Number" required="id"><br><br>
	   ...
	   <input type="number" id="text" name="room_number" placeholder="Room Number" required="id"><br><br>
